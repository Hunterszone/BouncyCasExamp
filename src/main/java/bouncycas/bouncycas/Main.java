...
public class Main
{
        ...
        throws GeneralSecurityException
    {
        ...
        String inputToString = new String(ExValues.SampleInput);
        System.out.println("Input string is: " + inputToString);
        System.out.println("Hashed with AESCMAC algorithm: " + Hex.toHexString(generateMacCMAC(secKey, ExValues.SampleInput)));
        System.out.println("Hashed with AESGMAC algorithm: " + Hex.toHexString(generateMacGMAC(secKey, ExValues.SampleInput)));
        System.out.println("Hashed with AESCCMMAC algorithm: " + Hex.toHexString(generateMacCCM(secKey, ExValues.SampleInput)));
   }
}